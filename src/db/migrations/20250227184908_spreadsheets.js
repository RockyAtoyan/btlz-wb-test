...
export async function up(knex) {
    return knex.schema
        .createTable("spreadsheets", (table) => {
        ...
        .createTable("boxes", (table) => {
            ...
            table
                ...
                .comment("Коэффициент, %. На него умножается стоимость доставки и хранения. Во всех тарифах этот коэффициент уже учтён");
...
export async function down(knex) {
    return knex.schema.dropTable("spreadsheets").dropTable("boxes");
}
